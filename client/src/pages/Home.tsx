...
export default function Home() {
  return (
    <div className="min-h-screen">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-4">
              <h3 className="text-secondary font-display text-2xl">I support children, families and teachers with:</h3>
              <ul className="space-y-3">
                {[
                  'Anxiety, worries, and fears',
                  'Big emotions and emotional regulation',
                  'Changes at home, separation, or loss',
                  'School, workplace or friendship challenges',
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container">
          <h2 className="text-foreground mb-12 text-center">What to expect</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card>
              <CardHeader>
                <CardTitle className="text-foreground">Children</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-foreground">Parents and Caregivers</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  Including parents and caregivers at various points in a child's therapy helps a child by improving communication within the family, addressing any underlying issues, and creating a supportive environment where everyone can work together to help the child overcome challenges. On-line sessions are available.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                <CardTitle className="text-foreground">Teachers</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  After many years of working in education I offer a safe, empathetic space to process stress, develop coping strategies, and build resilience, improving both personal well-being and effectiveness in the classroom. On-line sessions are available.
                </p>
              </CardContent>
            </Card>
          </div>
